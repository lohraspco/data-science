...
class SCUCScenarios():
    def __init__(self, filename="case_6bus.xlsx", getSCUCoutputFromFile=True):
        ...
        self.G = len(self.__gen)
        self.L = len(self.__line)
        self.T = len(self.__tvars)
        self.__numberOfComponents = self.G + self.L
    ...
    def resilience(self, ls, TTR, demand, alpha):
        # alphas are coeffieicents of convext combination
