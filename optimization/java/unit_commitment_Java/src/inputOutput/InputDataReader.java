...
public class InputDataReader {
	...
	IOException {
		...
		int ntType = _tokenizer.nextToken(); //read parameter name
		if (_tokenizer.ttype == StreamTokenizer.TT_WORD)
			paramName.add(_tokenizer.sval);
		else 
			throw new InputDataReaderException(_fileName);

		ntType = _tokenizer.nextToken();// read '='
		if (ntType!='=')
			throw new InputDataReaderException(_fileName);
	...
	IOException {
		...
		ntType = _tokenizer.nextToken(); // Read the '['
	...
	public double[] readDoubleArrayNoName() throws InputDataReaderException,
	IOException {
	...
	IOException {
		...
		while (ntType == '[') {
			...
			values.add(readDoubleArrayNoName());
	...
	public int[] readIntArrayNoName() throws InputDataReaderException,
	IOException {
		// this function is a copy of readIntArray to be used in readIntArrayArray
		int ntType = _tokenizer.nextToken(); // Read the '['
