...
if __name__ == "__main__":
    update_data()
# curs.execute(("""select 'stocks' from information_schema.tables WHERE table_schema='saffron'"""))
# print(curs.fetchall())
# curs.execute(("""select * from information_schema.tables WHERE table_schema='saffron'"""))
# print(curs.fetchall())
...
# metadata = db.MetaData()
# session = Session()
# census = db.Table('stocdata', metadata, autoload=True, autoload_with=engine,schema="saffron")
# subq = session.query(
#     census.symbol,
